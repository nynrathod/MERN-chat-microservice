...
function Messages() {
	...
	return (
		<>
			<div id="messages" className="chat-body p-4 flex-1 overflow-y-scroll">
				<div className="flex flex-row justify-start">
					...
					<div className="messages text-sm text-gray-700 grid grid-flow-row gap-2">
						<div className="flex items-center group">
							...
							<button type="button" className="group-hover:block  flex-shrink-0 focus:outline-none mx-2 block rounded-full text-gray-500 hover:text-gray-900 hover:bg-gray-700 bg-gray-800 w-8 h-8 p-2">
