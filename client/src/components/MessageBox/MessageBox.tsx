	...
	return (<>
		<div className="chat-footer flex-none">
			<div className="flex flex-row items-center p-4">
				...
				<button type="button" className=" flex-shrink-0 flex focus:outline-none mx-2 block text-blue-600 hover:text-blue-700 w-6 h-6">
					<svg viewBox="0 0 20 20" className="w-full h-full fill-current">
				...
				<div className="relative flex-grow">
					<label>
						...
						<button type="button" className="absolute top-0 right-0 mt-2 mr-3 flex-shrink-0 focus:outline-none block text-blue-600 hover:text-blue-700 w-6 h-6">
							<svg viewBox="0 0 20 20" className="w-full h-full fill-current">
